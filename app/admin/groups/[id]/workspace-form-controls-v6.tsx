...
export default function WorkspaceFormControlsV6() {
  ...
  useEffect(() => {
    ...
    if (rescheduleAlert) rescheduleAlert.textContent = 'Enter the new date and time, then save the assignment.'
  ...
  function deleteRecord(groupId: string) {
      ...
      {recordMeta ? (
        <details className={recordStyles.shell}>
          ...
          <div className={recordStyles.body}>
            ...
            {recordMeta.status === 'completed' ? <p className={recordStyles.state}>Record protected</p> : null}
            {recordMeta.status === 'cancelled' ? <p className={recordStyles.state}>Legacy record retained</p> : null}
                ...
                {canDelete ? (
                  <>
                    ...
                    <button
                      ...
                      onClick={() => deleteRecord(recordMeta.groupId)}
                      type="button"
