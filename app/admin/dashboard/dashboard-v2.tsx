...
export default async function DashboardV2({ searchParams }: {
  searchParams: Promise<{ confirmed?: string; error?: string; month?: string }>
}) {
    ...
    <section className="section admin-dashboard-page">
      <div className="container">
        <div className="dashboard-heading">
          <div><p className="eyebrow">Admin Dashboard</p></div>
        </div>
