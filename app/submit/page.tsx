...
export default async function SubmitResearchPage() {
  ...
  return <>
    <section className="page-head submission-page-head"><div className="container"><p className="eyebrow">Research Defense</p><h1>Submit, continue, or check your research.</h1><p className="lead">One Research ID follows your group from Title Defense through Proposal and Final Defense.</p></div></section>
